  ...
  render() {
    ...
    return (
        ...
        <div ref={(ref) => this.slideContainer = ref} 
          ...
          {contentGenerator('#1a3445','#c4d4e0','Hackathons and sprints give the freedom for your co-workers to experiment with new technologies in established industries. You can go from idea to working prototype with our expertise to discover and the future of your organization’s industry. ')}
