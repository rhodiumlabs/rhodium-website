  ...
  render() {
    ...
    return (
        ...
        <div ref={(ref) => this.slideContainer = ref} 
          ...
          {contentGenerator('#1a3445','#E9C77B','explore labs', 'Imagine your team controlling a drone with their brain as it flies through the air competing against an bot. Attendees don’t sit and listen to lectures on why technology matters - they experience it.')}
          ...
          {contentGenerator('#1a3445','#E9C77B','workshop', 'From blockchain to AI, haptics, and ambient computing, these two hour learning experiences are designed to immerse professionals in the inner workings of emerging technologies. We educate at any level- those with no previous experience to those who are senior decentralized developers.')}

          {contentGenerator('white','#E2B49A','', 'There is no "one size fits all" decentralized. We use our insight to dive deep into your industry\'s potential. We help you take advantage of opportunities in decentralized systems and ambient intelligence.', true)}
          {contentGenerator('white','#E2B49A','awareness', 'We identify and develop new opportunities for business innovation using analytics and immersion research. We work with you to understand your industry and your user through trends, human factors research, attribute mapping, and cultural validation.')}
          {contentGenerator('white','#E2B49A','strategize',             'We define a strategy by diagnosing the problems, set guiding policies, and plan coherent actions so you know where you want to be when the opportunity arises. We craft strategies and deliver clear and actionable guidance to our client to achieve big leaps forward.')}
          {contentGenerator('white','#E2B49A','market expertise',       'If your company is considering a decentralized systems or ambient intelligence implementation, we are here to help. We work with you to guide your business or technical choices through the field. Our expertise allow you to create the best team or product with specific goals.')}
          ...
          {contentGenerator('#1a3445','#c4d4e0','', 'We help you construct functional prototypes while testing in an agile cycle. From sprinting to the most innovative idea, to end to end productization, we then guide you to success. ',true)}
          {contentGenerator('#1a3445','#c4d4e0','Hackathons and sprints give the freedom for your co-workers to experiment with decentralized systems, and ambient intelligence. They can go from idea to working prototype with our expertise,  using emerging technologies to discover and own the future of their organization’s industry. ')}
          {contentGenerator('#1a3445','#c4d4e0','experiment', 'Creating decentralized systems and ambient intelligence proof of concept or prototypes requires efficiency. With our team of experts, if you need a specific project to be done well and built quickly— we are the right partner to work with.')}
          {contentGenerator('#1a3445','#c4d4e0','engineer', 'We apply extreme-programming and use an rapid, iterative approach to building products for physical and digital mediums. We architect your product and use our insights and strategy to help you achieve the your goals. This service requires serious commitment from you, as it is a extraordinarily technical and advanced offering.')}        
