  ...
  render() {
    ...
    return (
        ...
        <div ref={(ref) => this.slideContainer = ref} 
          ...
          {contentGenerator('#1a3445','#E9C77B', '', 'We teach stakeholders of established companies to uncover the changes and  opportunities that emerging tech will have on their industries, and where to find more information.', true)}
          {contentGenerator('#1a3445','#E9C77B','explore labs', 'Imagine your team controlling a drone with their brain as it flies through the air competing against an bot. You don’t sit and listen to lectures on why technology matters - you experience it. ')}
          {contentGenerator('#1a3445','#E9C77B','seminars', 'With an in-depth look at smart contracts, cryptocurrencies, and connected devices, these one hour seminars create an open space for you to learn why they affect their industry.')}
          {contentGenerator('#1a3445','#E9C77B','workshop', 'From blockchain to AI, haptics, and ambient computing, these three hour learning experiences are designed to immerse you in the inner workings of emerging technologies.')}

          {contentGenerator('white','#E2B49A','', 'There is no "one size fits all" decentralized. We use our insight to dive deep into  industry\'s potential. We help you take advantage of upcoming opportunities and face challenges head on.', true)}
          {contentGenerator('white','#E2B49A','awareness', 'We identify and develop new opportunities for business innovation using analytics and immersion research. We work with you to understand the industry and users through trends, human factors research, attribute mapping, and cultural validation.')}
          {contentGenerator('white','#E2B49A','strategize',             'We define a strategy by diagnosing the problems, set guiding policies, and plan coherent actions so you know where you want to be when the opportunity arises. We craft strategies and deliver clear and actionable guidance to you to achieve big leaps forward.')}
          {contentGenerator('white','#E2B49A','market expertise',       'If your company is considering a new implementations using these technologies, we are here to help. We work with you to guide your business or technical choices through the field. Our expertise allow you to create the best team or product with specific goals.')}
          {contentGenerator('white','#E2B49A','research',               'Not all ideas or problems have been solved. Our team can work together with recognized industry professionals to publish papers or use as supporting materials to fund your upcoming projects. These types of engagements require deep expertise and minimum of one month to be completed.')}
          
          {contentGenerator('#1a3445','#c4d4e0','', 'We help you construct functional prototypes while testing in an agile cycle. From sprinting to the most innovative idea, to end to end productization, we guide you to success.',true)}
          {contentGenerator('#1a3445','#c4d4e0','hackathons', 'Hackathons and sprints give the freedom for your co-workers to experiment with new technologies in established industries. You can go from idea to working prototype with our expertise to discover and the future of your organization’s industry. ')}
          {contentGenerator('#1a3445','#c4d4e0','experiment', 'Creating proof of concept or prototypes requires efficiency. Our team of experts will help you uncover and build these specific projects suitable for your business’s needs and strategy. ')}
          {contentGenerator('#1a3445','#c4d4e0','engineer', 'We apply extreme-programming and use an rapid, iterative approach to building products. By architecting your product and use our insights and strategy to help you achieve the your goals. This service requires serious commitment from you, as it is a extraordinarily technical and advanced offering.')}        
